...
**STEP 3:** Rename your work-flow related tfvars. For example in xc-bigip work-flow update `bigip/terraform.tfvars.examples` to `bigip/terraform.tfvars` and add the following data:
...
**Step 3:** Rename `xc/terraform.tfvars.examples` to `xc/terraform.tfvars` and add the following data:
  ...
  * xc_tenant       = "Your tenant id available in F5 XC `Administration` Tenant Overview menu"
