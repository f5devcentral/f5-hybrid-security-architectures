locals {
  ...
  bigip_cis = try(data.tfe_outputs.bigip-cis.values.bigip_cis, "false")
  bigip_k8s_partition = try(data.tfe_outputs.bigip-cis.values.bigip_k8s_partition, "")
  bigip_vip = try(data.tfe_outputs.bigip-base.values.bigip_private_vip_ip, "")
} 